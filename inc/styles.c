...
GUI_Color color_list = {
	.bg = 0xffffff, .fg = 0x000000, .light = 0xffffff, .dark = 0x0080cc,
	.border = 0x000000, .outline = 0
};
...
GUI_Shape shape_list = {
	.bump_out = 0, .bump_in = 0, .border = 0, .outline = 1, .radius = 0, .padding = 0, .margin = 0
};
...
GUI_Color color_panel_active = { .bg = 0xffffff, .fg = 0, .light = 0xcccccc, .dark = 0x333333 };
GUI_Color color_panel_passive = { .bg = 0, .fg = 0xffffff, .light = 0xcccccc, .dark = 0x333333 };
GUI_Shape shape_panel = { .bump_out = 0, .bump_in = 2 };
